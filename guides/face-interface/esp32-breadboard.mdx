...
# Building Haptic Face Interface for VR Headsets

Haptic Face Interface is the easiest SenseShift device you can build, and we recommend starting your journey with SenseShift with it! With 6 Haptic Feedback Points, you will deeply improve your immersion by feeling every touch and punch into your face.
...
:::note
You may need to adjust list according to your setup, e.g. changing face interface to a different model.
:::
...
| :------------: | :---: |
| ![ULN2803 on Breadboard](./assets/esp32-breadboard/schematic-step-2.png) | ![ULN2803 on Breadboard IRL](https://i.imgur.com/6ouCKcL.jpg) |
...
| Wiring Diagram | Photo |
| :------------: | :---: |
| ![ESP32 on Breadboard](./assets/esp32-breadboard/schematic-step-3-1.png) | ![ESP32 on Breadboard IRL](https://i.imgur.com/NtM7IXg.jpg) |

Connect pins `IO14`, `IO27`, `IO26`, `IO25`, `IO33`, `IO32` with your ULN2803 with jumper wires array as per diagram below.

| Wiring Diagram | Photo |
| :------------: | :---: |
| ![ESP32 on Breadboard](./assets/esp32-breadboard/schematic-step-3-2.png) | ![ESP32 on Breadboard IRL](https://i.imgur.com/GDmuFiE.jpg) |
...
| Wiring Diagram | Photo |
| :------------: | :---: |
| ![Motor connection](./assets/esp32-breadboard/schematic-step-final.png) | ![Vibration motors soldered](https://i.imgur.com/qigeFM0.jpg) |
...
Use any of our [Firmware Flashing methods](/docs/category/firmware) and flash Face Interface (Tactal) firmware.
...
<img
  src={require('./assets/esp32-breadboard/schematic-step-final.png').default}
