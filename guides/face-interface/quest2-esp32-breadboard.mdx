...
Our Face Interface is supported by many games and works great with Standalone VR headsets, such as Meta Quest 2. It achieves it by providing a compatibility layer for bHaptics, making it possible to support **bHaptics Tactal** supported games.
...
A small variety of hardware components is required to build your DIY Haptic Face Interface. You can find a table with list of required components below. You'll also need some tools, such as Soldering Iron for device assembly.
